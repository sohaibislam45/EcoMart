            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {values.map((value, index) => (
                        <div key={index} className="bg-primary-800/50 p-8 rounded-2xl border border-primary-700/50 hover:bg-primary-800 transition-colors text-center">
                            <div className="inline-flex p-4 rounded-full bg-primary-700/50 text-primary-300 mb-6">
                                {value.icon}
                            </div>
